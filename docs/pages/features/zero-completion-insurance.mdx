...
On your activity page, requests that were protected by zero completion insurance will show zero credits deducted. This applies even in cases where AiMo Network may have been charged by the provider for prompt processing.
