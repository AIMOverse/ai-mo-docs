...
**Solution**: Top up your escrow account with USDC at [https://aimo.network/demo/dashboard](https://aimo.network/demo/dashboard).
...
**Solution**: Verify the provider's Solana public key is correct. Find valid provider addresses at [https://aimo.network/demo/discover](https://aimo.network/demo/discover).
