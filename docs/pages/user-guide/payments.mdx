...
AiMo Network uses stablecoins for permissionless on-chain settlement. Users need to onramp fiat to crypto to use the network and offramp crypto to fiat to cash out.

:::info
We plan to integrate onramp/offramp providers into web applications and support stablecoin-focused blockchains in the future as usage increases. This will provide a seamless experience for users and increase network adoption.
:::

For most users, we recommend using [MoonPay](https://moonpay.io/). MoonPay is a popular onramp/offramp provider that supports multiple cryptocurrencies and fiat currencies.

For users in areas that face geo-restrictions, we recommend using P2P services provided by mainstream exchanges such as Binance, OKX, and other exchanges that are licensed in your country.

If you encounter any particular issues, do not hesitate to reach out to us by joining our [Discord server](https://discord.gg/G3zVrZDa5C) and get support, we will do our best to help you.
